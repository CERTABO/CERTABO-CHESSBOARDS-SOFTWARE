...
xcopy /s /e /h dist\run dist\result
...
xcopy /s /e /h pics dist\result\pics
mkdir dist\result\sprites_1380
xcopy /s /e /h sprites_1380 dist\result\sprites_1380
mkdir dist\result\sprites_1920
xcopy /s /e /h sprites_1920 dist\result\sprites_1920